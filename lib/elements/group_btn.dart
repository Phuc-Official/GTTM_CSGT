  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GridView.count(
        ...
        children: [
          _buildButton(
              'assets/logo/groupbtn/thong_tin.svg', 'Thông tin phương tiện',
              () {
          ...
          _buildButton(
              'assets/logo/groupbtn/phat_nguoi.svg', 'Tra cứu phạt nguội', () {
            Navigator.push(
              context,
              MaterialPageRoute(
          ...
          _buildButton(
              'assets/logo/groupbtn/dk_xe.svg', 'Giấy chứng nhận ĐK xe', () {
