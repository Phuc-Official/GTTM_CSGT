...
class _HomeState extends State<Home> {
      ...
      child: Row(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text('Hoặc', style: TextStyle(color: Colors.grey, fontWeight: FontWeight.w400)),
          ),
          Expanded(child: Divider(color: Colors.grey, thickness: 0.2)),
        ],
      ),
  ...
  Widget _buildQRButton() {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(colors: [AppColors.blueTop, AppColors.blueBot]),
          borderRadius: BorderRadius.circular(8.0),
        ),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            SvgPicture.asset('assets/logo/scan.svg', width: 20, height: 20, color: Colors.white),
            SizedBox(width: 8),
            Text('Quét mã QR', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          ],
        ),
      ),
    );
  ...
  Widget _buildNFCButton() {
    return GestureDetector(
      ...
      child: Container(
        ...
        padding: EdgeInsets.symmetric(vertical: 15),
        decoration: BoxDecoration(
          gradient: LinearGradient(colors: [AppColors.lightBlue, AppColors.lightBlue]),
          borderRadius: BorderRadius.circular(8.0),
        ),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            SvgPicture.asset('assets/logo/signal.svg', width: 20, height: 20, color: AppColors.blueText),
            SizedBox(width: 8),
            Text('Quét thẻ NFC', style: TextStyle(color: AppColors.blueText, fontWeight: FontWeight.bold)),
          ],
        ),
      ),
    );
  ...
  Widget _buildPlateNoButton() {
    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => PlateNoScan()));
      },
      child: Container(
        width: 300,
        padding: EdgeInsets.symmetric(vertical: 15),
        ...
        child: Row(
          ...
          children: [
            SvgPicture.asset('assets/logo/signal.svg', width: 20, height: 20, color: AppColors.blueText),
            SizedBox(width: 8),
            Text('Quét biển số xe', style: TextStyle(color: AppColors.blueText, fontWeight: FontWeight.bold)),
          ],
        ),
      ),
    );
